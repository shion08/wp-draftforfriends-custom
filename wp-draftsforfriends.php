...
class WPDraftsForFriends {
    ...
    public function admin_scripts( $hook_suffix ) {
        if( 'posts_page_wp-draftsforfriends/wp-draftsforfriends' === strtolower( $hook_suffix ) ) {
            ...
            // *## adding css and scripts needed for select2
            wp_register_style( 'select2css', 'https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/css/select2.min.css' );
            wp_enqueue_style('select2css');
            wp_register_script( 'select2js', 'https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/js/select2.min.js', array( 'jquery' ) );
